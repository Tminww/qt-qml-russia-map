...
Item {
    ...
    Rectangle {
        ...
        Canvas {
            id: mapCanvas
            anchors.fill: parent
            anchors.margins: containerMargin
            ...
            property real mapAspectRatio: 1000 / 800
            ...
            Rectangle {
                ...
                border.width: 1
                radius: 5
                visible: false  // Установите true для отладки
                ...
                Column {
                    ...
                    Text {
                        color: "#333333"
                        font.pixelSize: 11
                        text: "Регионов: " + (mapData && mapData.regions ? mapData.regions.length : 0)
                    }
                    Text {
                        color: "#333333"
                        font.pixelSize: 11
                        text: "Путей: " + regionPaths.length
                    }
                    Text {
                        color: "#333333"
                        font.pixelSize: 11
                        text: "Масштаб: " + actualScale.toFixed(3)
                    }
                    Text {
                        color: "#333333"
                        font.pixelSize: 11
                        text: "Смещение: " + offsetX.toFixed(0) + ", " + offsetY.toFixed(0)
                    }
                }
            }
            ...
            function calculateScaleAndOffset() {
                ...
                var baseMapHeight = 800

                var availableWidth = width - canvasPadding * 2
                var availableHeight = height - canvasPadding * 2
            ...
            Connections {
                ...
                function onSelectedRegionChanged(regionId) {
                    console.log("Сигнал: selectedRegionChanged", regionId)
